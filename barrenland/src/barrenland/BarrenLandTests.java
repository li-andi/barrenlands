...
class BarrenLandTests {
	...
	/**
	 * Test what happens if there are non numerical mixed with letters in input
	 * 
	 * @throws IOException
	 */
	...
	@Test
	@Order(17)
	public void testGetFertileLandArea17() throws IOException {
		List<Integer> expectedResult = Arrays.asList(240000);
		String input = "{“asdfeasdf”}";
		System.setIn(new ByteArrayInputStream(input.getBytes()));
		bl.readInput();
